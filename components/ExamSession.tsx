    ...
    return (
      <div className="fixed inset-0 bg-slate-50 flex flex-col items-center justify-center p-6 z-50 animate-in zoom-in-95">
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center space-y-6">
          ...
          <Button onClick={onExit} fullWidth className="py-3 text-lg">
            返回主页
          </Button>
        </div>
      </div>
             ...
             {step === 'QUESTION' ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button 
                    ...
                    className="flex flex-col items-center justify-center py-4 px-2 bg-emerald-100 border border-emerald-200 rounded-xl hover:bg-emerald-200 transition-all active:scale-95 shadow-sm group"
                  >
                  ...
                  <button 
                    ...
                    className="flex flex-col items-center justify-center py-4 px-2 bg-red-100 border border-red-200 rounded-xl hover:bg-red-200 transition-all active:scale-95 shadow-sm group"
                  >
