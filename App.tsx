...
import { PlusCircle, BookOpen, Trash2, BrainCircuit, ListOrdered, CheckCircle2, XCircle, BarChart2, FolderInput, CopyPlus, X, Clock, Edit, AlertTriangle, Settings, Download, Upload, FileJson, Check, GraduationCap, Play } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleReviewStat = (phraseId: string) => {
    setStats(prev => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      {view === AppView.EDIT_DECK && activeDeckId && (
        <DeckEditor
      ...
      {view === AppView.STUDY && activeDeckId && (
        <StudySession 
          deck={decks.find(d => d.id === activeDeckId)!} 
          onUpdateDeck={updateDeck}
      ...
      {view === AppView.EXAM_SESSION && activeDeckId && examConfig && (
        <ExamSession 
          deck={decks.find(d => d.id === activeDeckId)!}
